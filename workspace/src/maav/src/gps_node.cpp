...
int main(int argc, char **argv)
{
        ...
        else
        {
                ...
                (ros::Time::now() - last_request > ros::Duration(5.0)))
            {
                    ...
                    arm_cmd.response.success)
                {
                    ...
                    // Set our global target to our current target.
                    // 490 Altitude is a placeholder value that is a few meters off the ground.
                    // There is an incongruency in the frame for current_global and global_target
                    // altitude, so this will need to be figured out.
                    ...
                    global_target.pose.position.altitude = 490; //current_global.altitude;
    ...
    while (ros::ok())
    {
        // Continually publish our global target position to global position.
